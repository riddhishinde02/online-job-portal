...
const PostApplication = () => {
  const { singleJob } = useSelector((state) => state.jobs);//jobs management
  const { isAuthenticated, user } = useSelector((state) => state.user);//user management
  const { loading, error, message } = useSelector(
    (state) => state.applications
  );//application management

  const { jobId } = useParams(); //to get url data
